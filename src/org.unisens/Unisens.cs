...
namespace org.unisens
{
    ...
    public interface Unisens
    {
         ...
         */
        void setTimestampStart(DateTime timestampStart);
         ...
         * @
         */
        SignalEntry createSignalEntry(string id, string[] channelNames, DataType dataType, double sampleRate);
         ...
         * @
         */
        EventEntry createEventEntry(string id, double sampleRate);
         ...
         * @
         */
        ValuesEntry createValuesEntry(string id, string[] channelNames, DataType dataType, double sampleRate);
         ...
         * @
         */
        CustomEntry createCustomEntry(string id);
         ...
         * @
         */
        Entry addEntry(Entry entry, bool deepCopy);
         ...
         * @
         */
        Group addGroup(Group group, bool deepCopy);
